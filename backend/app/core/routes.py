...
import coaches.router as coaches_router
...
import students.router as students_router
import training.router as training_router
...
import users.user_roles.router as user_roles_router
...
router.include_router(
    coaches_router.router,
    prefix=core_config.ROOT_PATH + "/coaches",
    tags=["coaches"],
    dependencies=[Depends(session_security.validate_access_token)],
)
router.include_router(
...
router.include_router(
    ...
    prefix=core_config.ROOT_PATH + "/students",
    tags=["students"],
    dependencies=[Depends(session_security.validate_access_token)],
)
router.include_router(
    training_router.router,
    prefix=core_config.ROOT_PATH + "/training",
    tags=["training"],
    dependencies=[Depends(session_security.validate_access_token)],
)
router.include_router(
...
router.include_router(
    user_roles_router.router,
    prefix=core_config.ROOT_PATH + "/user-roles",
    tags=["user_roles"],
    dependencies=[Depends(session_security.validate_access_token)],
)
router.include_router(
